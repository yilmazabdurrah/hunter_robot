...
DogtoothController::DogtoothController() : controller_interface::ControllerInterface() {}

const char * DogtoothController::feedback_type() const
{
  return params_.position_feedback ? HW_IF_POSITION : HW_IF_VELOCITY;
}

controller_interface::CallbackReturn DogtoothController::on_init()
{ 
  ...
  // char buffer[1024];
  // publisher_ = get_node()->create_publisher<std_msgs::msg::String>("/dogtooth/battery_status", 10);
  return controller_interface::CallbackReturn::SUCCESS;
}

InterfaceConfiguration DogtoothController::command_interface_configuration() const
{
...
InterfaceConfiguration DogtoothController::state_interface_configuration() const
{
  std::vector<std::string> conf_names;
  // for (const auto & joint_name : params_.left_wheel_names)
  // {
...
void DogtoothController::update_time()
{
...
std::string DogtoothController::add_zero(int value){
...
controller_interface::return_type DogtoothController::update(
...
controller_interface::CallbackReturn DogtoothController::on_configure(
...
controller_interface::CallbackReturn DogtoothController::on_activate(
  const rclcpp_lifecycle::State &)
{
...
controller_interface::CallbackReturn DogtoothController::on_deactivate(
  const rclcpp_lifecycle::State &)
{
...
controller_interface::CallbackReturn DogtoothController::on_cleanup(
  const rclcpp_lifecycle::State &)
{
  if (!reset())
  {
...
controller_interface::CallbackReturn DogtoothController::on_error(const rclcpp_lifecycle::State &)
{
  if (!reset())
  {
    return controller_interface::CallbackReturn::ERROR;
...
controller_interface::CallbackReturn DogtoothController::on_shutdown(
  const rclcpp_lifecycle::State &)
{
  return controller_interface::CallbackReturn::SUCCESS;
}

void DogtoothController::halt()
{

}

controller_interface::CallbackReturn DogtoothController::configure_side(
...
CLASS_LOADER_REGISTER_CLASS(
  dogtooth_controller::DogtoothController, controller_interface::ControllerInterface)
