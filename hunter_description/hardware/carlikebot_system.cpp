  ...
  const hardware_interface::HardwareInfo & info)
{
  ...
  // code
  hw_start_sec_ = std::stod(info_.hardware_parameters["param_hw_start_duration_sec"]);
  hw_stop_sec_ = std::stod(info_.hardware_parameters["param_hw_stop_duration_sec"]);
...
hardware_interface::return_type hunter_description ::CarlikeBotSystemHardware::write(
  const rclcpp::Time & /*time*/, const rclcpp::Duration & /*period*/)
{
  // BEGIN: This part here is for exemplary purposes - Please do not copy to your production code
  std::stringstream ss;
...
PLUGINLIB_EXPORT_CLASS(
  hunter_description::CarlikeBotSystemHardware, hardware_interface::SystemInterface)
